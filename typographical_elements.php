    ...
    <main>
        ...
        <div>
            <section class="large">
                <div>
                    ...
                    <img class="right" src="assets/images/fonts-typefaces.png" alt="">
                    <p>
        ...
        <div>
            <section class="large">
                <div>
                    <h3>White Space</h3>
                    <img class="right" src="assets/images/macro-whitespace.png" alt=""/>
                    <p>
        ...
        <a href="principles.php">Principles of Typography &rarr;</a>
    </main>
