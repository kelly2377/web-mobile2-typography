<?php
$currentPage = "Principles of Typography | Fundamentals";
    ...
    <main>
        ...
        <div>
            <section class="large">
                ...
                <img src="assets/images/legibility-readability.png" alt="">
            </section>
        </div>
        ...
        <div>
            <section class="large">
                <div>
                    ...
                    <p>
                        As a fundamental principle in UI design, consistency should be a top priority in typography. Using too many different fonts can create confusion, so it's best to stick to a cohesive set of styles that clearly convey important information and build familiarity.
                    </p>
                </div>

                <img src="assets/images/consistency-2.png" alt=""/>
            </section>
        </div>
        ...
        <div>
            <section class="large">
                ...
                <img src="assets/images/contrast-2.png" alt=""/>
            </section>
        </div>
        ...
        <div>
            <section class="large">
                ...
                <img src="assets/images/repetition.png" alt=""/>
            </section>
        </div>
        ...
        <div>
            <section class="large">
                ...
                <img src="assets/images/alignment.gif" alt=""/>
            </section>
        </div>
    </main>
